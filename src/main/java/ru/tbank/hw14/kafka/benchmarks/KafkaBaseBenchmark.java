...
public abstract class KafkaBaseBenchmark extends AbstractBenchmark {

    private final int producersNumber;
    private final int consumersNumber;

    private static final String TEST_TOPIC = "test-topic";
    private static final String BOOTSTRAP_ADDRESSES = "localhost:29092";
    ...
    public KafkaBaseBenchmark(int producersNumber, int consumersNumber) {
